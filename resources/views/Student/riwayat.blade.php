                ...
                <table class="table-auto w-full text-sm text-left text-gray-600">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="border px-4 py-3 text-gray-700">Keterangan</th>
                    ...
                    <tbody>
                        @foreach ($riwayat as $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border px-4 py-3 capitalize">{{ $item->jenis_penarikan }}</td>
                                <td class="border px-4 py-3 capitalize">{{ $item->keterangan }}</td>
