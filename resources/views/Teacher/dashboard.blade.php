...
@section('content')
        ...
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-gray-600 font-medium">Total Tabungan</h3>
                <p class="text-3xl font-bold text-blue-700 mt-2">
                    Rp{{ number_format($totalPemasukan - $totalPenarikan, 0, ',', '.') }}
                </p>
            </div>
            <div class="bg-blue-100 text-blue-700 font-bold p-3 rounded-full transform hover:scale-110 transition">
