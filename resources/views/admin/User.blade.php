            ...
            <div class="bg-white rounded-2xl p-6 space-y-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        <h2 class="text-lg sm:text-xl  font-extrabold">Tambah Guru</h2>
                        <p class="text-gray-600 mt-2 text-sm">Tambahkan akun guru baru ke dalam sistem.</p>
                        <a href="{{ route('admin.tambahguru') }}"
                            class="mt-4 inline-block bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-lg transition w-full text-center">
                            Tambah Guru
                        </a>
                    </div>
                    ...
                    {{-- Tambah Siswa --}}
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        <h2 class="text-lg sm:text-xl font-extrabold ">Tambah Siswa</h2>
                        <p class="text-gray-600 mt-2 text-sm">Tambahkan akun siswa baru ke dalam sistem.</p>
                        <a href="{{ route('admin.tambahsiswa') }}"
                            class="mt-4 inline-block bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition w-full text-center">
                            Tambah Siswa
                        </a>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-red-50 rounded-xl shadow-md">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-700">Guru Tidak Aktif</h3>
                            <p class="text-2xl font-bold text-red-400">{{ $guruTidakAktif }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-green-50 rounded-xl shadow-md">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-700">Guru Aktif</h3>
                            <p class="text-2xl font-bold text-green-400">{{ $guruAktif }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-red-50 rounded-xl shadow-md">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-700">Siswa Tidak Aktif</h3>
                            <p class="text-2xl font-bold text-red-400">{{ $siswaTidakAktif }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-green-50 rounded-xl shadow-md">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-700">Siswa Aktif</h3>
                            <p class="text-2xl font-bold text-green-400">{{ $siswaAktif }}</p>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse($gurus as $guru)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2">
                                            <p>Terakhir aktif:
                                                {{ $guru->last_active_at ? $guru->last_active_at->diffForHumans() : '' }}</p>
                                        </td>
                                        <td class="px-3 py-2">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-gray-500">Belum ada data guru.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @forelse($siswas as $siswa)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2">{{ optional($siswa->kelas)->nama_kelas ?? '-' }}</td> 
                                        <td class="px-3 py-2">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-gray-500">Belum ada data siswa.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
