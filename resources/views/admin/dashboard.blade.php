                ...
                <div class="bg-white shadow p-6 rounded-lg border border-gray-200">
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-500">Disetor oleh:
                            @if (isset($setoransByKelas[$kelas]) && count($setoransByKelas[$kelas]) > 0)
                                <span class="font-medium text-gray-800">
                                    {{ implode(', ', $setoransByKelas[$kelas]) }}
                                </span>
                            @else
                        ...
                        <p class="text-sm text-gray-500">Ditarik oleh:
                            @if (isset($penarikansByKelas[$kelas]) && count($penarikansByKelas[$kelas]) > 0)
                                <span class="font-medium text-gray-800">
                                    {{ implode(', ', $penarikansByKelas[$kelas]) }}
                                </span>
                            @else
