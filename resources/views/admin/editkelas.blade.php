...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl p-6 space-y-10">
            <h2 class="text-2xl font-extrabold">Edit Kelas</h2>
            ...
            <form action="{{ route('admin.updateKelas', $kelas->id) }}" method="POST">
                ...
                <div>
                    <button type="submit"
                        class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-2 px-4 rounded-lg transition w-full text-center">
                        Update Kelas
                    </button>
                </div>
            </form>
