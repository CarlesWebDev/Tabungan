    ...
    <div class="min-h-screen flex items-center justify-center  py-8 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-6xl rounded-2xl overflow-hidden ">
            <div class="flex flex-col md:grid md:grid-cols-2 gap-0">
                ...
                <div class="hidden md:flex items-center justify-center 10">
                ...
                <!-- Form Column -->
                <div class="flex flex-col justify-center px-4 py-8 sm:px-8 md:p-10">
                    ...
                    <div class="text-center md:text-left mb-8">
                        ...
                        <p class="text-gray-600 text-sm md:text-base">Gunakan kredensial Anda untuk mengakses dashboard
                            siswa</p>
                    </div>
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-6 space-y-6 text-center text-sm text-gray-600">
                        <div>
                            ...
                            <a href="{{ route('login.guru') }}" class="font-medium text-blue-600 hover:text-blue-500">Masuk
                                sebagai guru</a>
                        </div>
                        <div>
